...
/**
 * Agent endpoints: a.k.a Receivers.
 *
...
public class CommandChannelAgentEndpointHandler extends CommandChannelEndpointHandler {
    ...
    /**
     * The path this handler is registered for. Must not include version prefix.
     */
    public static final String PATH = "/systems/{systemId}/agents/{agentId}";
