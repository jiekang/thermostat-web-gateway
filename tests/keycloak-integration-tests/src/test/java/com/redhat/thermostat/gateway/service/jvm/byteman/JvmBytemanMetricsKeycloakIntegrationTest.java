...
public class JvmBytemanMetricsKeycloakIntegrationTest extends BasicKeycloakIntegrationTestSuite {
    private static final String serviceName = "jvm-byteman";
    ...
    public JvmBytemanMetricsKeycloakIntegrationTest() {
    ...
    protected List<EndpointDefinition> getEndpointList() {
        ...
        endpointDefinitions.add(new EndpointDefinition(HttpMethod.GET, endpoint + "/jvms/jid1", EndpointDefinition.NO_BODY));
        endpointDefinitions.add(new EndpointDefinition(HttpMethod.POST, endpoint +"/systems/sid1/jvms/jid1", postData));
